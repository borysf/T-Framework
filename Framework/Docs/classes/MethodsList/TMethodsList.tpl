        ...
        <com:Repeater id="List" onItemDataBind="List_DataBind">
            ...
            <prop:itemTemplate>
                    <li>
                        ...
                        <com:HyperLink id="Name" html.class="method name" /> (
                            <com:.classes.ArgumentsList id="Arguments" />
                        )<com:Literal id="TypePrefix" text=" : " visible="false" /><com:.classes.TypesList id="Type" /> 
