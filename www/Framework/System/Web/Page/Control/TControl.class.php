...
abstract class TControl extends TComponent
{
    ...
    public function getSystemId(): ?string
    {
        if ($this->parent) {
            ...
            return substr(sha1($parentId . '|' . $this->parent->__controlIndex($this) . $key), 0, 10);
        }
    ...
    /**
     * Adds given control next to another specified child control.
     */
    public function addControlNextTo(TControl $control, TControl $nextTo) {
        $this->addControl($control, array_search($nextTo, $this->children, true) + 1);
    }
